$(function() {
    ...
    function initSlider() {
        ...
        for(var i = 0; i < amt; i++) {
            if(i == 0)
                $('.all').append('<span style="background-color:#aaaaaa;"></span>');
            else
                $('.all').append('<span></span>');
        }
    }
    ...
    function goToSlider(cursor) {
        ...
        $('.all span').css('background-color','#c8c8c8');
        $('.all span').eq(cursor).css('background-color','#aaaaaa');
